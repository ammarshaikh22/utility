...
class NewSupportTicket extends BaseNotification
{
    ...
    {
        // Initialize the notification with the support ticket and related settings
        $this->ticket = $ticket;
    ...
    public function via($notifiable)
    {
        ...
        // Add mail channel if email notifications are enabled for both the setting and the notifiable
    ...
    public function toMail($notifiable)
    {
        ...
        return parent::build()
            ->subject(__('superadmin.newSupportTicket.subject') . ' - ' . config('app.name')) // Set email subject with app name
            ->greeting(__('email.hello') . ' ' . $notifiable->name . '!') // Personalized greeting
            ->line(__('superadmin.newSupportTicket.text')) // Include new support ticket message
    ...
    public function toOneSignal($notifiable)
    {
        ...
        return OneSignalMessage::create()
            ->subject(__('email.newTicket.subject')) // Set push notification subject
            ->body(__('email.newTicket.text')); // Set push notification body
    }
}
```